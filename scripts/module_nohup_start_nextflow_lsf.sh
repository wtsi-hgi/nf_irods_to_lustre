...
nohup nextflow run /software/hgi/pipelines/yascp_nf_irods_to_lustre/pipelines/main.nf \
      -c /software/hgi/pipelines/yascp_nf_irods_to_lustre/nextflow.config -c /software/hgi/pipelines/yascp_nf_irods_to_lustre/scripts/inputs.nf -profile lsf \
